...
OpenAI's [Codex CLI](https://developers.openai.com/codex/cli/) now supports the open [Agent Skills standard](https://agentskills.io) so this now works with Claude Code or Codex!
:::
...
> I have cloned the llm plugin llm-fecfile to @llm-fecfile/ . I would like to convert it to an Agent Skill. Let's break it into tasks.
...
From there, it began porting all of Derek's hard work into the necessary Markdown and script structure. Minutes later, I had [agent-fecfile](https://github.com/hodgesmr/agent-fecfile) (formerly called `claude-fecfile`) and you can have it too:

::: {.callout-warning}
Installing someone else's Agent Skill means you're letting the agent run someone else's **prompts** and **code**. I trust me. Do you trust me?
:::
...
::: {.callout-note}
New install instructions are documented in the [agent-fecfile repository](https://github.com/hodgesmr/agent-fecfile).
:::
